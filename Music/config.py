...
MONGO_DB_URI = getenv("mongodb+srv://SEMO1:SEMO1@cluster0.rusaedi.mongodb.net/?retryWrites=true&w=majority")
SUDO_USERS = list(map(int, getenv('SUDO_USERS', '6228635168').split()))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/asaaqaa/SohaMusic")
